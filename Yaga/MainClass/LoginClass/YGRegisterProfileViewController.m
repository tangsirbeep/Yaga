//
//  YGRegisterProfileViewController.m
//  Yaga
//
...
@interface YGRegisterProfileViewController () <UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIPickerViewDataSource, UIPickerViewDelegate>
...
@implementation YGRegisterProfileViewController
...
- (instancetype)initWithEmail:(NSString *)email password:(NSString *)password {
    ...
    if (self) {
        ...
        _selectedAvatarName = @"headplace";
        _selectedAvatarDataBase64 = @"";
...
- (void)saveButtonTapped {
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(2.0 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        BOOL success = [[YGUserStore sharedStore] registerUserWithEmail:self.email
        ...
        [YGHUDHelper showText:@"Registration successful." inView:self.view];
...
- (void)presentPickerOverlayWithTitle:(NSString *)title
    ...
    [NSLayoutConstraint activateConstraints:@[
        ...
        [contentView.leadingAnchor constraintEqualToAnchor:self.pickerContainerView.leadingAnchor constant:0.0],
        [contentView.trailingAnchor constraintEqualToAnchor:self.pickerContainerView.trailingAnchor constant:0.0],
